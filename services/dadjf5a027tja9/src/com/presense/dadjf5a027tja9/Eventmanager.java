...
/**
 * Eventmanager generated by hbm2java
 */
@Entity
...
private Manager manager;
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="managerId", column=@Column(name="manager_id", nullable=false) ) } )
    public EventmanagerId getId() {
        return this.id;
    }
    
    public void setId(EventmanagerId id) {
        this.id = id;
    }
