...
/**
 * Specifies methods used to obtain and modify Attendance related information
 * which is stored in the database.
 */
@Repository("dadjf5a027tja9.AttendanceDao")
public class AttendanceDao extends WMGenericDaoImpl <Attendance, Long> {
