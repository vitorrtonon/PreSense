...
/**
 * Specifies methods used to obtain and modify Beacon related information
 * which is stored in the database.
 */
@Repository("dadjf5a027tja9.BeaconDao")
public class BeaconDao extends WMGenericDaoImpl <Beacon, String> {
