...
/**
 * Specifies methods used to obtain and modify Event related information
 * which is stored in the database.
 */
@Repository("dadjf5a027tja9.EventDao")
public class EventDao extends WMGenericDaoImpl <Event, Long> {
