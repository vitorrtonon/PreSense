...
/**
 * Specifies methods used to obtain and modify Sensor related information
 * which is stored in the database.
 */
@Repository("dadjf5a027tja9.SensorDao")
public class SensorDao extends WMGenericDaoImpl <Sensor, Long> {
